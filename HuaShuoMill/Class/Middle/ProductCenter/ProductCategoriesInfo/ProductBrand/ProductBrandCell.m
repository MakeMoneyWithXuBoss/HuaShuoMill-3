...
@implementation ProductBrandCell

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *identify = @"ProductBrandCell";
    ProductBrandCell *cell = [tableView dequeueReusableCellWithIdentifier:identify];
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"ProductBrandCell" owner:self options:nil] lastObject];
    }
    return cell;
}
